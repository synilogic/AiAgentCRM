...
const Login = () => {
  ...
  const features = [
    { icon: <WhatsAppIcon />, text: 'WhatsApp Integration', color: '#25D366' },
    { icon: <AutoAwesomeIcon />, text: 'AI-Powered Responses', color: '#6366f1' },
    { icon: <TrendingUpIcon />, text: 'Advanced Analytics', color: '#10b981' },
  ];
